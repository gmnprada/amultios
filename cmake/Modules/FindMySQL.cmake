...
if(CMAKE_BUILD_TYPE STREQUAL Debug)
  set(_lib_suffix debug)
else()
  set(_lib_suffix release)
endif()
...
if( WIN32 )
	...
	find_path( MYSQL_INCLUDE_DIR
		NAMES "mysql.h"
		PATHS "${CMAKE_SOURCE_DIR}/ext/MySQL/mysql-connector-c-6.1.11-win32/include"  )
	
	find_library( MYSQL_LIBRARY
		NAMES "mysqlclient" "mysqlclient_r"
		PATHS "${CMAKE_SOURCE_DIR}/ext/MySQL/mysql-connector-c-6.1.11-win32/lib/${_lib_suffix}" )
